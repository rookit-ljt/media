...
function create() {
    // 以下是创建画布背景
    context.rect(10, 20, canvasWidth, canvasHeight);
...
export default {
    ...
    listen(classname) {
        ...
        canvasDiv.addEventListener("mousedown", function(e){
            console.log(left)
            console.log(top)
            console.log("此处的e"+JSON.stringify(e))
            paint = true;
            classname && (this.className = classname);
            // addClick(e.pageX - left-1000, e.pageY - top+410);
            console.log("此处的e.pageX"+e.pageX)
            console.log("此处的e.pageY"+e.pageY)
            addClick(e.pageX - left, e.pageY - top-50);
            draw();
        });
        ...
        canvasDiv.addEventListener("mousemove", function(e){
            ...
            // addClick(e.pageX - left-1000, e.pageY - top+410, true);
            addClick(e.pageX - left, e.pageY - top-50, true);
            draw();
        });
